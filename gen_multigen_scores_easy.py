...
if __name__ == "__main__":
	...
	# python gen_multigen_scores_easy.py --result_path sample_jsons/TokenCompose_SD14_A --name TokenCompose_SD14_A
	# --threshold 0.1 --text_file_path coco_obj_comp_5_1k.json --num_ins 5 --img_per_prompt 10 --num_images 100

	parser = argparse.ArgumentParser() 
	parser.add_argument("--result_path", default="sample_jsons/StableDiffusion1.4")
	parser.add_argument("--name", default="StableDiffusion1.4")
