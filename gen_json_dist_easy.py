########################################################################################################################################################################################################################################################################################
############################################################################################# This code is based on the code from TokenCompose/multigen/ in here : https://github.com/mlpc-ucsd/TokenCompose.git #######################################################################
...
if __name__ == "__main__":
    ...
    # python gen_json_dist_easy.py --image_dir sample_imgs/TokenCompose_SD14_A --output_json_path sample_jsons/TokenCompose_SD14_A 
    # --text_file_path coco_obj_comp_5_1k.json --num_ins 5 --img_per_prompt 10 --threshold 0.1 --detector mlpc-lab/TokenCompose_SD14_A
    
    parser = argparse.ArgumentParser()
    parser.add_argument("--image_dir", type=str, default="sample_imgs/StableDiffusion1.4")
    parser.add_argument("--output_json_path", type=str, default="sample_jsons/StableDiffusion1.4")
